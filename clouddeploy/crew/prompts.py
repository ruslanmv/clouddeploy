...
def diagram_edit_prompt(user_request: str, prior_code: str) -> str:
    return f"""{SYSTEM_BASE}

{DIAGRAM_RULES}

You are EDITING an existing diagram.

Rules:
- Keep Mermaid diagram type as architecture-beta.
- Return the FULL updated Mermaid code (not a diff).
- Also return an updated composer_graph reflecting the edits.
